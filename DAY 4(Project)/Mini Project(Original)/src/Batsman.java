...
public class Batsman extends Player{
    ...
    public void display(){
        super.display();
        System.out.println("Display total number of Innings : "+getInnings());
        System.out.println("Display total runs : "+getRuns());
        System.out.println("Display total no of hundreds : "+getHundred());
        System.out.println("Display total no of fifties : "+getFifty());
    }
    public void read(){
        super.read();
